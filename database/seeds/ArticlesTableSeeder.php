    ...
    public function run()
    {
        DB::table('articles')->insert([
            [
                ...
                'article_url' => 'https://www.gate15.be/nl/nieuws/help-ons-de-cultuurcheques-te-optimaliseren'
            ],
            [
                ...
                'article_url' => 'https://www.gate15.be/nl/nieuws/kick-off-voor-antwerpse-presidia-7'
            ],
            [
                ...
                'article_url' => 'https://www.gate15.be/nl/nieuws/starterssessies-toekomstige-zelfstandigen-bijna-afgestudeerden'
            ]
        ]);
    }
}
